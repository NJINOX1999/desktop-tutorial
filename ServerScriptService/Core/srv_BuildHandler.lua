...
BuildRequest.OnServerEvent:Connect(function(player, itemId, pos, rot)
    ...
    if pos.Magnitude > MAX_BUILD_RADIUS or pos.Magnitude ~= pos.Magnitude then
        return
    end
    ...
    if tower then
        ...
        data.Coins = math.max((data.Coins or 0) - cost, 0)
